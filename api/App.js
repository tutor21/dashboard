...
const App = () => {
  ...
  const handleGenerateEmbedScript = () => {
    ...
    // UPDATED: baseUrl now points to the new Render domain
    const baseUrl = 'https://dashboard-q84h.onrender.com/api/embed.html';
      ...
      <div className="max-w-4xl w-full bg-white rounded-xl shadow-lg p-6 md:p-8">
        ...
        <section className="p-6 bg-green-50 rounded-lg shadow-inner">
          ...
          <p className="text-gray-700 mb-4">
            ...
            You will need to host the content from the "Embed Script Content (URL Target)" immersive at the URL `https://dashboard-q84h.onrender.com/api/embed.html` for this embed script to work.
          </p>
          <button
